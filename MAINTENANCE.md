# Zeta — maintenance and internals

How it works, what it costs, how to fix it, and the traps already paid for. For how to *use*
it, see **[README.md](README.md)**; to install it from scratch, **[SETUP.md](SETUP.md)**.

Zeta runs on **Modal** (what you actually use) or on **this PC** (for tuning voices without
spending money); `config.py` switches on the `ZETA_CLOUD` env var.
